...
intellisense: ${EXTENSION_CONFIG_STEP}
	...
	cmake  -DEXTENSION_STATIC_BUILD=1 -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DDUCKDB_EXTENSION_CONFIGS=${EXT_CONFIG} -DENABLE_UNITTEST_CPP_TESTS=FALSE   -DCMAKE_BUILD_TYPE=Release -S "./duckdb/" -B build/release && \
